            ...
            <Section altBg={true} className={styles.container}>
                <div>
                    ...
                    <p>
                        ...
                        speak the language of clients and senior executives whilst also communicating directly with
                        design and development teams to deliver work that solves real-world problems.
                    </p>
                    <p>
                    ...
                    <p>
                        Beyond my tertiary qualifications and experience, my personality and <strong>compassion</strong>{' '}
                        for others means I can mobilise and motivate teams effectively and thrive in{' '}
                        <strong>deadline-driven environments</strong>. I enjoy taking the lead and being the organiser,
                        but also love to get my hands dirty at a grassroots level.
                    </p>

                    <h3>On a personal note...</h3>
                    <p>
                        I'm from Australia and now living in Berlin with my wife Claire and son Charlie. We love travel,
                        people, music, art, projects and nature. Being Aussie, we enjoy the sunshine - but also the
                        cold, grey weather of Berlin too!{' '}
                    ...
                    <p>
                        <strong>
                            ...
                            <a
                                href="https://www.linkedin.com/in/lucasarundell"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                LinkedIn
